...
// #define LCD_BUFF_CACHE_SIZE  (1228800)  //1024*600*2

/* private typedef ------------------------------------------------------*/

// unsigned char lcd_buff_cache[LCD_BUFF_CACHE_SIZE] = {0};
...
static gt_disp_drv_st drv;
	...
	static gt_color_t buf_all[GT_SCREEN_WIDTH * GT_SCREEN_HEIGHT];// __attribute__((section(".bss.ARM.__at_0x80180000")));
#endif
