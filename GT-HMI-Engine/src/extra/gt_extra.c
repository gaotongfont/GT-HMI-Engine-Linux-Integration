...
// uint8_t img_color_buffer[1024 * 600 * (sizeof(gt_opa_t) + sizeof(gt_color_t))] = {0};
/**
...
void _gt_extra_init(void)
{
    ...
    gt_gc_set_full_img_buffer(img_color_buffer, 1024 * 600 * (sizeof(gt_opa_t) + sizeof(gt_color_t)));
#endif
